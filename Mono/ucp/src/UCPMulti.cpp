...
int main (int argc, char *argv[])
{
  ...
  //  moeoSteadyHyperVolumeContinue<IndiX> continuator( 0, 100, hyperVol);
    int time_max = parser.getORcreateParam(600, "time_max", "time max", 'T', "Algorithm").value();
    eoTimeContinue<IndiX> continuator(time_max);
    moeoDecodedNSGAII<IndiS, IndiX> nsgaII(5000, decoder, cross,pCross,mut, pMut,vectMut,pVectMut); 
