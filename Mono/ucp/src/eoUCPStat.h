 ...
 */
template <class EOT>
class eoUCPStat : public eoStat<EOT, double>
{
public :
...
// START eventually add or modify the anyVariable argument
   ...
   */
  eoUCPStat(std::string _description = "eoUCPStat ") :
...
// END eventually add or modify the anyVariable argument
  ...
  virtual std::string className(void) const { return "eoUCPStat"; }
private :
// START Private data of an eoUCPStat object
  //  varType anyVariable;		   // for example ...
// END   Private data of an eoUCPStat object
};
