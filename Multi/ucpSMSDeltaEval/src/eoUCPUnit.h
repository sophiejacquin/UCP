...
class eoUCPUnit{
 ...
 public:
   ...
   * eoUCPUnit<EOT> class consctructor*/
	 ...
	 eoUCPUnit(int _numMachine, unsigned int _Pmin, unsigned int _Pmax, double _a0, double _a1, double _a2, double _b0, double _b1, double _b2, unsigned int _tUp, unsigned int _tDown, double _sHot, double _sCold, int _tColdStart, int _initialState) :numMachine(_numMachine), Pmin(_Pmin), Pmax(_Pmax), a0(_a0), a1(_a1), a2(_a2), b0(_b0), b1(_b1), b2(_b2), tUp(_tUp), tDown(_tDown), sHot(_sHot), sCold(_sCold), tColdStart(_tColdStart), initialState(_initialState)
  {
  ...
  /*!
  * \brief Get the constant b0
  *
  * \return the b0 value
  */
  inline double get_b0()const
  {
	  return b0;
  }

  /*!
  * \brief Get the constant b1
  *
  * \return the b1 value
  */
  inline double get_b1()const
  {
	  return b1;
  }

  /*!
  * \brief Get the constant b2
  *
  * \return the b2 value
  */
  inline double get_b2()const
  {
	  return b2;
  }
 ...
 private:
  ...
  double b0; /*!< Constant associated to the CO2 Objective*/
  double b1; /*!< Constant associated to the CO2 Objective*/
  double b2; /*!< Constant associated to the CO2 Objective*/
