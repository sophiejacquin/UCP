...
// START eventually add or modify the anyVariable argument
  eoUCPSecondQuadCrossover(vector<int> & _tUp, vector<int> & _tDown, vector<int> & _tCS,eoUCPData * _data)
	{
		tUp= _tUp;
		tDown= _tDown;
		tColdStart=_tCS;
	 ...
	 for(t=TS+1;t<TE+1;t++)
    	 {
             ...
             for(int alpha=0;alpha<_genotype1.getN()+1;alpha++)
             {
                 double eval1_1=_genotype1.getEval1(alpha,t);
                 double eval1_2=_genotype1.getEval2(alpha,t);
                 _genotype1.setEval1(alpha,t,_genotype2.getEval1(alpha,t));
                 _genotype1.setEval2(alpha,t,_genotype2.getEval2(alpha,t));
                 _genotype2.setEval1(alpha,t,eval1_1);
                 _genotype2.setEval2(alpha,t,eval1_2);
