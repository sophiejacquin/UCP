...
public:
  ...
  /** printing... */
    void printOn(ostream& os) const
    {
       ...
       //   if( this->diversity()==DBL_MAX)
        os<<this->objectiveVector()[0]<<"   "<<this->objectiveVector()[1];
   ...
   */
    ...
    void setModif(vector<bool> _modif)
    {
        modif=_modif;
    }
    ...
    vector<double> getEval1()
    {
        return eval1;
    }
    vector<double> getEval2()
    {
        return eval2;
    }
	...
	{eval2[i]=e;}
    void setEvals(vector<double> ev1,vector<double> ev2)
    {
        eval1=ev1;
        eval2=ev2;
    }
